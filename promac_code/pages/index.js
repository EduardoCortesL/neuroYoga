    ...
    <div className="relative">
      ...
      <header className="relative flex items-center justify-center h-screen sm:mb-12 overflow-hidden">
        ...
        <div className="grid grid-cols-1">
          <div className="relative z-30 text-6xl text-white sm:text-45l font-extrabold">
              Your one stop shop
          </div>
          <div className="relative z-30 text-6xl text-white sm:text-6l font-extrabold">
              For all you consulting needs.
          </div>
        </div>
        
        <video autoPlay loop muted playsInline className="absolute z-10 w-auto min-w-full min-h-full max-w-none" >
          <source src="https://firebasestorage.googleapis.com/v0/b/bito-b4105.appspot.com/o/37427_construction_on_bridge_on_site_in_field_aerial_By_The_Stock_Studio_Artlist_HD.mp4?alt=media&token=90d1af61-c538-4cde-a084-2275181e8dde" type="video/mp4" />
      ...
      <main className="flex flex-col items-center justify-center sm:px-20 text-center">
        ...
        <div className="w-full my-14 pb-8 sm:p-8 text-sm sm:text-lg font-bold bg-gradient-to-r from-yellow-500 to-orange-500">
